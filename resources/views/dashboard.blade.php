...
<html lang="en">
  <head>
    ...
    <title>DPP Inkindo | Dashboard</title>
          ...
          <ul
            ...
            <li>
              <a href="{{route('master-gambar')}}">
                <i class="bi bi-circle"></i><span>Master Gambar</span>
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="forms-layouts.html">
                <i class="bi bi-circle"></i><span>Master lain</span>
              </a>
            </li>
          </ul>
        </li>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <span class="badge bg-{{$item->isOnline >= true ? 'success' : 'danger'}}">{{$item->isOnline >= true ? 'online' : 'offline'}}</span>
