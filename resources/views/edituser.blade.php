...
<html lang="en">
    <head>
        ...
        <title>DPP Inkindo | Edit User and Role</title>
    ...
    <body>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        >
                            ...
                            <li class="message-item">
                                <a href="#">
                                    <img
                                        src="{{asset('assets/img/messages-1.jpg')}}"
                                        alt=""
                            ...
                            <li class="message-item">
                                <a href="#">
                                    <img
                                        src="{{asset('assets/img/messages-2.jpg')}}"
                                        alt=""
                                        class="rounded-circle"
                                    />
                                    <div>
                            ...
                            <li class="message-item">
                                <a href="#">
                                    <img
                                        src="{{asset('assets/img/messages-3.jpg')}}"
                                        alt=""
                                        class="rounded-circle"
                                    />
                                    <div>
            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{route('user-role')}}">User and Role</a>
                        </li>
                        <li class="breadcrumb-item active">Edit User and Role</li>
                    </ol>
                </nav>
            </div>
            <!-- End Page Title -->
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('edit-user')}}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="exampleName" name="name" required value="{{$dataUser->name}}">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail" class="form-label">Email</label>
                                    <input type="email" class="form-control" id="exampleInputEmail" name="email" required value="{{$dataUser->email}}">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="exampleRole" name="role" required>

                                        @if($dataUser->role == 'admin')
                                        <option value="admin" selected>Admin</option>
                                        <option value="marketing">Marketing</option>
                                        @elseif($dataUser->role == 'marketing')
        ...
        <script>
             function showPassword() {
                var passwordField = document.getElementById("examplePassword");
